        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 btn-toolbar justify-content-end">
                    <button class="btn btn-dark me-2" onclick=" printInvoice();"><i class="bi bi-filetype-fill"  ></i>Print</button>
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-12 fw-bold text-end">
                                    <span>Maradana, Colombo, Sri Lanka</span><br />
                                    <span>+94 112 543423</span><br />
                        ...
                        <div class="col-12 mb-4">
                            <div class="row">
                                ...
                                <div class="col-6 text-end mt-4">
                                    <h1 class="text-primary text-uppercase">Invoice 0<?php echo $invoice_data["id"]; ?></h1>
