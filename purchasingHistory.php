                            ...
                            ?>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        $u_email = $product_data["user_email"];
                                        ...
                                        <div class="col-6 col-lg-1 text-center text-lg-end">
                                            <label class="form-label fs-4 py-5"><?php echo $invoice_data["qty"] ?></label>
                                        </div>

                                        <div class="col-6 col-lg-1 bg-success text-center text-lg-end">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-secondary border border-1 fs-5 rounded mt-5 border-primary" onclick="addFeedback(<?php echo $invoice_data['product_id'] ?>);">
